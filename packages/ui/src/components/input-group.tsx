...
function focusInputInAddon(element: HTMLElement) {
  ...
  return (
    <button
      ...
      onClick={(e) => {
        ...
        focusInputInAddon(e.currentTarget);
      }}
      onKeyDown={(e) => {
        if ((e.target as HTMLElement).closest("button") !== e.currentTarget) {
          return;
